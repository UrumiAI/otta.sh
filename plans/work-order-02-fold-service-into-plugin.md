...
**INC-C4 `[Plugin]` Cron hook: four sweeps plus four new sweepers** — branch `feat/plugin-cron-sweeps`.
...
completion (D2)**, and **reporting rollup heal (D3 item 4)**. Test first: a sandbox suite driving the
